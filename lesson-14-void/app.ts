...
// с попощью void мы можем обозначить некоторую группу функций, которые будут выполнять с какими-то входными параметрами, но возвращать нам ничего не нужно и мы будем это игнорировать
type voidFn = () => void
